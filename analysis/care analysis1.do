...
clear all
global moddir = "C:\Justin\dev\SimPaths\output\sc analysis1\csv"
...
// block 4 statistics
matrix store4 = J(2070-2018,8,.)
forvalues yy = 2019/2070 {
	qui{
		count if (time==`yy' & dag<45)
		mat store4[`yy'-2018,1] = r(N)
		count if (time==`yy' & dag<65 & needCare)
		...
		mat store4[`yy'-2018,7] = r(N)
		count if (time==`yy' & dag>79 & needCare)
		mat store4[`yy'-2018,8] = r(N)
	}
}
matlist store4
